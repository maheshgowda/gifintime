  ...
  class SupplierAbility
    ...
    def initialize(user)
      ...
      if user.supplier
        ...
        #can [:admin, :manage, :stock], Spree::ProductTranslation do |property|
        #  property.product.supplier_ids.include?(user.supplier_id)
        #end
        
        #can [:admin, :index, :update, :create, :read], Spree::Translation
        
        can [:admin, :index, :read], Spree::Property
        #can [:admin, :read], Spree::Prototype
        can [:admin, :index, :update, :create, :read], Spree::Prototype #todo later temparary fix
        #can [:admin, :index, :update, :create, :read], Spree::Translation
